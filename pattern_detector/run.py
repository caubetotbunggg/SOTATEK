...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--threshold", type=float, default=0.60, help="Final confidence threshold")
    parser.add_argument("--min-scale", type=float, default=0.8, help="Minimum template scale")
    parser.add_argument("--max-scale", type=float, default=1.2, help="Maximum template scale")
    parser.add_argument("--scale-step", type=float, default=0.1, help="Template scale step")
    ...
    parser.add_argument("--top-k", type=int, default=200, help="Top candidates to keep per scale/rotation")
    ...
    parser.add_argument("--chamfer-sigma", type=float, default=3.0, help="Distance-to-similarity sigma")
