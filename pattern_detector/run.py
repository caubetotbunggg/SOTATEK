...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--method", choices=["existing", "skeleton_sliding_window"], default="existing", help="Detection method")
...
def main() -> None:
    args = parse_args()
    if args.method == "skeleton_sliding_window":
        ...
        detections, visualization, summary = detect_skeleton_sliding_window(
